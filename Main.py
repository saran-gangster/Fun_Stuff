...
def check():
    try:
        get("https://saran-gangster.github.io/")
        internet = True
        print(color)
...
def banner():
	...
	printf "            \e[101m\e[1;77m:: responsible for any misuse or damage caused by fun Stuff::\e[0m\n"
	printf "\n"
	''')
...
if  target == '':
    ...
    print("Please Enter Correct Mobile Number and Number of Msgs or Contact me.")
